            ...
            <>
                <Form>
                    ...
                    <Form.Group>
                        ...
                        <Form.Control type="text" placeholder="Personaje"
                    ...
                    <Form.Group>
                        ...
                        <Form.Control type="text" placeholder="Habilidad"
                    ...
                    {/* <Form.Group>
                        ...
                        <Form.Control type="text" placeholder="Opening"
                    ...
                    <Form.Group>
                        ...
                        <Form.Control type="text" placeholder="Saga"
                        value={guerrero.saga}
                        name='saga'
                        onChange={(e)=> (handleGuerrero(e.currentTarget.name, e.currentTarget.value))}/>
                        <Form.Text></Form.Text>
