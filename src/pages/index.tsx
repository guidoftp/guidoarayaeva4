...
export default function Home() {
  return (
    <>
      <nav>
        <Link href="/Registrar">Registrar Guerrero Z </Link><br></br>
        <Link href="/Datos">Datos Guerrero Z</Link><br></br>
        <Link href="/Login">Administrador</Link><br></br>
      </nav>
      <h1>Bienvenidos a un FanPage de Dragon ball Z</h1><br></br>
        ...
        <section><br></br>
        <h2>Personajes</h2><br></br>
        <ol>
            <strong>Goku (Kakarotto): </strong>Goku es un saiyajin que llega a la Tierra y se dedica a defenderla de un montón de personajes malignos.<br></br>
            <strong>Vegeta: </strong> Vegeta es el príncipe de una raza guerrera extraterrestre conocida como los Saiyajin. Es extremadamente arrogante, orgulloso y trabajador; constantemente se refiere a su herencia y estatus real a lo largo de la serie.<br></br>
            <strong>Broly:</strong> Broly es descrito como un saiyajin de corazón puro, sin embargo su padre Paragus, siempre culpo al rey vegeta de su exilio, de modo que Broly también guardo cierto resentimiento hacia la familia real; Broly es un hombre amable pero posee una transformación especial con la que es capaz de liberar el poder de un Ozaru<br></br>
            <strong>Frezzer:</strong> Fue el primer gran enemigo de Son Goku en su etapa adulta, seguido de Cell y Majin Boo. Freezer es ampliamente considerado el antagonista más emblemático de la serie debido a servir efectivamente como el catalizador de muchos de los acontecimientos descritos en la historia.<br></br>
            <strong>Cell:</strong> es un bioandroide creado por la computadora del Dr. Gero, quien vino del futuro de la línea 3 con la intención de vengarse de Goku por haber acabado con el Ejército del Listón Rojo, y con ello el sueño de todo villano: dominar el mundo.<br></br>
            <strong>Majin Buu:</strong> Es el último gran enemigo al que se enfrentan los héroes en Dragon Ball Z, un espíritu hecho de la maldad del universo de color rosado con poderes mágicos, entre los cuales están convertir a quien quiera en dulce o curación y habilidades como regenerarse casi de forma infinita y absorber personas<br></br>
        </ol>
        </section>
        ...
        <p><strong>Akira Toriyama:</strong> fue un mangaka y diseñador de personajes japonés. Primero alcanzó reconocimiento popular tras crear la serie de manga Dr. Slump, y actuar como diseñador de personajes para videojuegos.</p>
            <strong>Nacimiento:</strong> 5 de abril de 1955, Nagoya, Prefectura de Aichi, Japón<br></br>
            <strong>Fallecimiento:</strong> 1 de marzo de 2024, Japón.<br></br>
        </section>
